...
public class FaceMesh: MonoBehaviour
{
    ...
    void EyeBlinking()
    {
        //float eyes_min = Mathf.Min(ear_left, ear_right);
        ...
        //eyes_min = Mathf.Clamp(eyes_min, ear_min_threshold, ear_max_threshold);

        //float x = Mathf.Abs((eyes_min - ear_min_threshold) / (ear_max_threshold - ear_min_threshold) - 1);
    ...
    public void SmileGesture()
    {
        ...
        {
            //ref_main_face.SetBlendShapeWeight(34, 100); //¿ÞÂÊ ÀÔ²¿¸®
